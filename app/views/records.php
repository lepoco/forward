                ...
                <tbody>
                    ...
                    if (!empty($query)) {
                        foreach ($query as $record) {
                            ...
                            $html .= '<td><a href="' . $this->baseurl . $this->Forward->Options->Get('dashboard', 'dashboard') . '/records/' . $record['record_id'] . '">' . $record['record_display_name'] . '</a></td>';
                            $html .= '<td class="table-record-url">' . $record['record_url'] . '</td>';
                            $html .= '<td>' . (empty($record['record_description']) ? $this->__('Empty') : $record['record_description']) . '</td>';

					...
					<div class="splash__card__body">
						...
						<form id="login-form" class="login-form">
							...
							<div class="form-group">
								<input type="text" autocomplete="username" class="form-control" name="login" id="login" placeholder="<?php $this->_e('Enter username/email'); ?>">
							</div>
							<div class="form-group" style="margin-top: 10px;">
								<div class="input-group input-password-preview password-hidden">
									<input type="password" autocomplete="current-password" class="form-control input-password-preview__field" id="password" name="password" placeholder="<?php $this->_e('Password'); ?>">

		...
		<div class="col-12 col-md-9">
			...
			<div id="github-about">
				<a href="https://github.com/rapiddev/forward" target="_blank" rel="noopener">
					<svg style="width:18px;height:18px" fill="#000" viewBox="0 0 24 24">
			...
			<h4>Used technologies & things</h1>
				<ul class="list-unstyled">
					...
					<li style="margin-bottom: 10px;"><i>Browser.php</i> by the Chris Schuld<br><a href="https://github.com/cbschuld/Browser.php">https://github.com/cbschuld/Browser.php</a><br><small>Browser.php is open-sourced software licensed under the MIT license.</small></li>

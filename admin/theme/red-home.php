...
<section id="red-home">
		...
		<div class="row">
			...
			<div class="col-12 col-lg-6">
				<div id="home-card">
					<div class="card">
						<div class="card-body">
							<h1>Forward | <?php echo $this->e('Short links manager'); ?></h1>
							<p><?php echo $this->e('Access to the site requires administrator privileges'); ?></p>
						</div>
						<a href="https://github.com/rapiddev/forward" target="_blank" rel="noopener" class="btn btn-primary">
							<div id="github">
								...
								<p>Forward | <?php echo $this->e('Create your own link shortener'); ?></p>
							</div>
						</a>
					</div>
				</div>
	...
	<div id="home-footer">
		...
		<br>
		<?php echo $this->e('Logo font'); ?>: Questrial by <i>Joe Prince</i>
	</div>
</section>
